...
//////////////////////////////////////////////////////////////////
function echoResultTablePng($result, $colTitles, $idcom, $colPng, $resultPngInfo) {
    if(!$result) {
    	echo "ERREUR!!!";
        echo "<br />";
        echo $idcom->error;
...
//				logbug($requetePng);
				...
				if ($png && $png[0][0] == '<') {
				    ...
				    echo "<div id=\"divpng$divIndex\">$png[0]</div>"; // affichage PNG
					
				    echo "<script>\n";
//				$jsonPng = json_encode($png[0]);
//				echo "displayPng(\"divpng$divIndex, $jsonPng\");\n";

					
					$slashesPng = addslashes($png[0]);
//				    echo "displayPng($divIndex,$rowPngInfo[0],$rowPngInfo[1],$rowPngInfo[2],$rowPngInfo[3],$rowPngInfo[4],$rowPngInfo[5],$rowPngInfo[6],\"$rowPngInfo[7]\",\"$slashesPng\");\n";  // appel DISPLAY PNG

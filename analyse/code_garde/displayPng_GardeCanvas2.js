...
function displayPng(divIndex, winInnerHeight,clientX, clientY, targetRectL, targetRectT, targetRectW, targetRectH, type, slashesPng) {
    

    var divPng = document.getElementById('divpng' + divIndex);
    var imgPngDiv = document.createElement('div');
    var slashesImgPng = slashesPng;
    slashesImgPng.replace(/\\/g,'');    
    
    imgPngDiv.innerHTML = slashesImgPng;
    var imgPng = imgPngDiv.firstChild;

...
// ****************************************************************************	
//	logbug('Dis requete: '.$requeteDisplay);	
...
//		echo "sessionStorage.sessions = $jsonArray";
...
<!--		<p style="margin-left:6px;color:red;font-size:24px;font-weight:bold;">SiouXplay</p>-->
		...
		<div class="boutGroupReplay">
			<p style="font-size:18px;" class="petit-titre">Auto.</p>
...
<!--		<label for="speed" class="titre medium light-blueColor" title="vitesse">&nbsp;V:</label>
		...
		<div class="boutGroupReplay">
			<p style="font-size:18px;" class="petit-titre">Manuel</p>
			<button title="Evènement Précédant" onmouseup="this.blur();" id="backward" class="titre large blackColor boutReplay body"><span>&nbsp;<</span>&nbsp;&nbsp;&nbsp;</button>
			<button title="Evènement suivant" onmouseup="this.blur();" id="foreward" class="titre large blackColor boutReplay body">&nbsp;&nbsp;&nbsp;<span>>&nbsp;</span></button>
...
<!--			<label for="event-num" class="titre medium light-blueColor" title="Position" style="color:white;"><</label>-->
			...
			<button title="Premier évènement" onmouseup="this.blur();" id="begin" class="titre large blackColor boutReplay body" ><span>|<</span>&nbsp;&nbsp;&nbsp;</button>
			<button title="Dernier évènement" onmouseup="this.blur();" id="end" class="titre large blackColor boutReplay body">&nbsp;&nbsp;&nbsp;<span>>|</span></button>
		</div>
